...
const ProductDetails = () => {
  ...
  if (loading) {
    return (
      <>
        <div className=" mt-10 mb-20 flex flex-row items-center justify-evenly ">
          <div>
  ...
  return (
    <>
      <button
        className=" ml-24 mt-8 text-white bg-purple-500 border-0 h-8 py-1 px-4 text-center focus:outline-none hover:bg-purple-600 rounded sticky top-0  z-10"
          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex btn1">
                ...
                <button
                  className=" btn1 btn2 inline-flex ml-5 text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded text-lg"
                  onClick={() => AddtoCart(product, true)}
                >
                  Buy Now
                </button>
                <button
                  className=" btn1 btn2 inline-flex ml-auto  border border-2  py-2 px-6  focus:outline-none hover:bg-purple-600 rounded hover:text-white"
